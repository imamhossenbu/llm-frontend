...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      Memory: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.MemoryFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.MemoryAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type MessageOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "role" | "content" | "createdAt" | "chatId", ExtArgs["result"]["message"]>
  ...
  export type MemoryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "key" | "value" | "createdAt", ExtArgs["result"]["memory"]>
  ...
  export interface MemoryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Memories that matches the filter.
     * @param {MemoryFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const memory = await prisma.memory.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: MemoryFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Memory.
     * @param {MemoryAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const memory = await prisma.memory.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: MemoryAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
   ...
   * Memory findRaw
   */
  export type MemoryFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * Memory aggregateRaw
   */
  export type MemoryAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
